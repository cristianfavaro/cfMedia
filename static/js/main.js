...
$(window).on('load', function() {
	/*------------------
		JS que faz a tela ficar preta até carregar as coisas. Efeito bem legal
	--------------------*/
	$(".loader").fadeOut();
...
(function($) {
	/*------------------
		Navigation
	--------------------*/
	$('.header-section .container').append('<div class="mobile-nav-switch"><i class="fa fa-bars" aria-hidden="true"></i></div><ul class="mobile-menu"></ul>')
